...
class EntidadesModeloTest {
    ...
    class DisciplinaTests {
        ...
        void aceitaPreRequisitos() {
            Disciplina d = new Disciplina(
                    "d1", "ALG01", "Alg", 40, 3, "c1", List.of("pre-1", "pre-2"));
    ...
    class BlocoHorarioTests {
        ...
        void criaBlocoValido() {
            BlocoHorario b = new BlocoHorario(
        ...
        void rejeitaHorarioInvalido() {
            assertThrows(
                    IllegalArgumentException.class,
                    () -> new BlocoHorario(
                            DayOfWeek.TUESDAY, LocalTime.of(10, 0), LocalTime.of(9, 0)));
        }

        @Test
        void equalsConsideraDiaEHorarios() {
            BlocoHorario a = new BlocoHorario(
                    DayOfWeek.WEDNESDAY, LocalTime.of(14, 0), LocalTime.of(16, 0));
            BlocoHorario b = new BlocoHorario(
                    DayOfWeek.WEDNESDAY, LocalTime.of(14, 0), LocalTime.of(16, 0));
            assertEquals(a, b);
        }
    ...
    class TurmaTests {
        ...
        private BlocoHorario blocoPadrao() {
            return new BlocoHorario(
                    DayOfWeek.THURSDAY, LocalTime.of(19, 0), LocalTime.of(21, 0));
        }
        ...
        void alteraHorarios() {
            Turma t = new Turma(
                    ...
                    List.of(blocoPadrao()),
                    false);
            BlocoHorario novo = new BlocoHorario(
                    DayOfWeek.FRIDAY, LocalTime.of(8, 0), LocalTime.of(10, 0));
        ...
        void rejeitaLimiteVagasInvalido() {
            Turma t = new Turma(
                    "d1", "p1", "prof", 20, "S1", LocalDate.now(), List.of(blocoPadrao()));
    ...
    class UsuarioTests {
        ...
        void equalsPorId() {
            Usuario a = new Usuario(
                    "id-x", PerfilUsuario.ADMINISTRADOR, "Admin", "1", "a@b.com", "s", true);
            Usuario b = new Usuario(
                    "id-x", PerfilUsuario.COORDENADOR, "Outro", "2", "c@d.com", "s2", false);
            assertEquals(a, b);
        }
