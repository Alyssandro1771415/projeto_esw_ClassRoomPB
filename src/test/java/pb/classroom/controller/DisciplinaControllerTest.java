...
class DisciplinaControllerTest {
    ...
    void setUp() {
        ...
        autenticacaoController = new AutenticacaoController(List.of(
                ...
                new Usuario(PerfilUsuario.ALUNO, "Aluno Teste", "A001", "aluno@classroompb.com", SENHA)));
        disciplinaController = new DisciplinaController(autenticacaoController, List.of(), List.of(curso));
    }
