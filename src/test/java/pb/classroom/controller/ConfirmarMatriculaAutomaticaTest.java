...
class ConfirmarMatriculaAutomaticaTest {
  ...
  void setUp() {
    ...
    discFisica =
        new Disciplina(
            "disc-fisica", "FIS01", "Física I", 60, 4, "curso-1", List.of("disc-calculo"));
    discMecanica =
        new Disciplina(
            "disc-mecanica",
            "MEC01",
  ...
  void matriculaConfirmadaQuandoHaVagas() {
    ...
    MatriculaController controller =
        criarController(List.of(), List.of(turma), List.of(discCalculo));
  ...
  void matriculaEmEsperaQuandoTurmaLotada() {
    ...
    MatriculaController controller =
        criarController(List.of(mat1, mat2), List.of(turma), List.of(discCalculo));
  ...
  void segundaMatriculaFicaEmEsperaQuandoUltimaVagaPreenchida() {
    ...
    MatriculaController controller =
        criarController(List.of(existente), List.of(turma), List.of(discCalculo));
  ...
  void matriculaConfirmadaSemPreRequisitos() {
    ...
    MatriculaController controller =
        criarController(List.of(), List.of(turmaCalculo), List.of(discCalculo));
  ...
  void matriculaRejeitadaComPreRequisitoNaoAtendido() {
    ...
    MatriculaController controller =
        criarController(List.of(), List.of(turmaFisica), List.of(discCalculo, discFisica));
  ...
  void matriculaConfirmadaComMultiplosPreRequisitosAtendidos() {
    ...
    Turma turmaFisica = criarTurmaDiaDiferente("turma-fis", "disc-fisica", 30);
    Turma turmaMecanica =
        criarTurma("turma-mec", "disc-mecanica", 30, DayOfWeek.WEDNESDAY, "14:00", "16:00");
    Matricula matCalculo = new Matricula("mat-cal", aluno.getId(), turmaCalculo.getId());
  ...
  private MatriculaController criarController(
      List<Matricula> matriculas, List<Turma> turmas, List<Disciplina> disciplinas) {
    return new MatriculaController(
        autenticacaoController, matriculas, turmas, List.of(periodoAtivo), disciplinas);
  }
  ...
  private Turma criarTurma(
      String id, String idDisciplina, int limiteVagas, DayOfWeek dia, String inicio, String fim) {
    return new Turma(
        id,
        idDisciplina,
        periodoAtivo.getId(),
