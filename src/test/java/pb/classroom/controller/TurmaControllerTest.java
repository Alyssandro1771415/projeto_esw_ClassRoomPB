...
class TurmaControllerTest {
  ...
  void setUp() {
    ...
    autenticacaoController =
        new AutenticacaoController(List.of(coordenador, professor, outroProfessor, aluno));
    turmaController =
        new TurmaController(
            autenticacaoController,
            List.of(),
    ...
    assertAll(
        ...
        () ->
            assertThrows(
                ...
                () ->
                    new BlocoHorario(
                        DayOfWeek.MONDAY, LocalTime.parse("10:00"), LocalTime.parse("08:00"))));
  }
  ...
  void alunoConsultaApenasTurmasEDisciplinasDisponiveis() {
    Disciplina disciplinaSemOfertaDisponivel =
        new Disciplina(
            "disc-2",
            "ESW102",
    ...
    Turma turmaCancelada =
        criarTurma(disciplinaSemOfertaDisponivel.getId(), periodoLetivo.getId(), true);
    Turma turmaPeriodoEncerrado =
        criarTurma(disciplinaSemOfertaDisponivel.getId(), periodoEncerrado.getId(), false);
    turmaController =
        new TurmaController(
            autenticacaoController,
    ...
    assertAll(
        ...
        () ->
            assertThrows(
                UnsupportedOperationException.class, () -> turmasDisponiveis.add(turmaCancelada)),
        () ->
            assertThrows(
  ...
  private List<BlocoHorario> horarios(String inicio, String fim) {
    return List.of(
        new BlocoHorario(DayOfWeek.MONDAY, LocalTime.parse(inicio), LocalTime.parse(fim)));
  }
}
