...
class MatriculaRequisitosRf16aRf22Test {
    ...
    void setUp() {
        ...
        disciplina = new Disciplina("disc-1", "ESW101", "Projeto de Software", 60, 4, "curso-1", List.of());
    }
    ...
    void cancelamentoDeConfirmadaPromovePrimeiroAlunoDaEspera() {
        Turma turma = criarTurma("turma-1", 1, LocalDate.now().plusDays(30));
        Matricula confirmada = new Matricula("mat-1", aluno.getId(), turma.getId(), StatusMatricula.CONFIRMADA);
        Matricula espera = new Matricula("mat-2", outroAluno.getId(), turma.getId(), StatusMatricula.EM_ESPERA);
